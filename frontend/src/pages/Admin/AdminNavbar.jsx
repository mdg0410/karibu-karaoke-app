...
const AdminNavbar = ({ onSeccionChange, seccionActiva, onLogout }) => {
    ...
    <nav className="bg-dark-card border-b border-primary/20 py-4 px-4 sm:px-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center">
          <div className="text-primary text-2xl font-bold mr-4">Karibu Admin</div>
          
          {/* Menú desktop - visible en pantallas lg y superiores por tener más items */}
        ...
        <div className="flex items-center space-x-4">
          {/* Botón de menú hamburguesa - visible solo en pantallas medianas y pequeñas */}
          <button 
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden sm:inline">{currentUser?.nombre || 'Admin'}</span>
            </button>
      ...
      {/* Menú móvil - solo visible cuando está abierto y en pantallas pequeñas y medianas */}
      {mobileMenuOpen && (
