...
const AdminLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Aquí iría la llamada a la API para autenticar al admin
    // Por ahora, simularemos una autenticación exitosa con datos estáticos
    
    // Verificamos las credenciales (simulado)
    if (formData.email === 'admin@karibu.com' && formData.password === 'admin123') {
      ...
      // Token simulado
      const token = 'jwt-token-admin-simulado';
